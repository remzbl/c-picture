package com.remzbl.cpictureback.model.entity;
 ...
 * @TableName user
 */
@TableName(value ="User") //指定该实体类所对应的数据库表名
@Data
public class User implements Serializable {
     ...
     * id
     */
    @TableId(type = IdType.ASSIGN_ID)  //生成一个长整形数字
    private Long id;
     ...
     * 是否删除
     */
    @TableLogic  //逻辑删除字段  加上后查询数据时mybatisplus会自动添加if判断来确保查询的数据是未删除的
